...
const FloatingButtons = () => {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a
        href="tel:9500595550"
        className="flex items-center justify-center h-14 w-14 rounded-full accent-gradient text-accent-foreground shadow-lg hover:scale-110 transition-transform"
        aria-label="Call Now"
      >
